...
export default function SellingLinkBanner({ sellingLink, colorIndex = 0 }: SellingLinkBannerProps) {
  ...
  return (
    <Link
      href={sellingLink.link}
      target="_blank"
      rel="noopener noreferrer"
      className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg overflow-hidden hover:ring-2 hover:ring-gray-600 transition-all duration-300 border border-gray-700"
    >
