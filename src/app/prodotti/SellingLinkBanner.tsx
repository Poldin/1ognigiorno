...
export default function SellingLinkBanner({ sellingLink, colorIndex = 0 }: SellingLinkBannerProps) {
  ...
  return (
    <div
      ...
      className="flex-shrink-0 w-64 bg-gray-800 rounded-lg overflow-hidden cursor-pointer hover:ring-2 hover:ring-gray-600 transition-all duration-300 border border-gray-700"
    >
